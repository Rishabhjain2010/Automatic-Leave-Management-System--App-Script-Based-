function fillSpecificColumnsCR() {
    var sheetId = "1trq37tFuu6a0tCgrM9ZfcHsQvG4VqEmfwUYkjKmaZVQ"; // Replace with your actual sheet ID
    var sheetName = "Cancellation Request"; // Replace with your actual sheet name
  ...
  for (var row = 1; row < values.length; row++) {
    ...
    values[row][totalRequestRaised] = "=COUNTIF(B2:B"+rangecounter+",B"+rangecounter+")";
    
    values[row][totalLeavesRequested] = "=K"+rangecounter+"-J"+rangecounter+"+1" ;
